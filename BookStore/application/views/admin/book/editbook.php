...
<div class="wrapper">
	   	...
	   	<!-- Form -->
		<form class="form" id="form" action="<?php echo base_url('admin/book/edit/').$info->id_book;?>" method="post" enctype="multipart/form-data">
			<fieldset>
				<div class="widget">
				    <div class="title">
...
<div class="formRow">
	...
	<div class="formRight">
		<div class="left"><input type="file"  id="image" name="image" accept="image/*" style="color: blue;" >
			<p style="color: red;">Chỉ chọn khi muốn thay đổi ảnh.</p>
		</div>
...
<div class="formRow">
	...
	<div class="formRight">
		<span class="oneTwo">
			<input name="price"  style='width:100px' id="param_price" class="format_number" _autocheck="true" type="text" required value="<?php echo $info->price;?>" />
...
<div class="formRow">
	...
	<div class="formRight">
		<span class="oneFour"><input name="author" id="param_warranty"  type="text" value="<?php echo $info->author?>" /></span>
...
<div class="formRow">
	...
	<div class="formRight">
		<select name="id_type" _autocheck="true" id='param_cat' class="left" 
		required>
			<option value="">Lựa chọn danh mục</option>
						      <!-- kiem tra danh muc co danh muc con hay khong -->
						      <?php foreach($types as $t):?>
						      	<?php if($t->id_type == $info->id_type)
						      		{
...
<div class="formRow">
	...
	<span class="req">*</span>
	<div class="formRight">
		<textarea name="description" id="param_content" class="editor" 
		required style="height: 200px;" ><?php echo $info->description;?></textarea>
