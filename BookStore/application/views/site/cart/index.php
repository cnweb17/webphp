...
<div class="cart_container">
		...
		<?php foreach($cart as $row):?>
			...
			<div class="list_details">
				...
				<div class="list_details_mid">
					<p style="font-size: 16px;color: red; margin-top: 22px;"><?php echo number_format($row['price'],3)?> VNĐ</p>
				</div>
				<div class="list_details_right">
					...
					<div style="margin-left: 30px; margin-top: 20px;">
						<a href="<?php echo base_url('site/cart/del/'.$row['id']);?>">
							<img width="20px" height="25px" src="<?php echo public_url('site/images/deleteicon.png');?>">
						</a>
					</div>
		...
		<?php endforeach;?>
			...
			<div class="list_footer">
				...
				<div class="list_footer_right">
					<a id="delete_all" href="<?php echo base_url('site/cart/del');?>">
						Xóa tất cả
					</a>
				</div>
			</div>
	...
	<div class="payment">
		...
		<div class="payment_footer">
			<a class="checkout" href="<?php echo base_url('site/order');?>">
